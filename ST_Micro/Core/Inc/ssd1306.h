...
typedef void(*writePtr)(uint8_t address, uint8_t reg, uint8_t data);

typedef void(*writeMultiPtr)(uint8_t address, uint8_t reg, uint8_t *data, uint16_t count);

typedef uint8_t(*initPtr)();
...
/*
 * Attach functions.
 * These functions assign a main function to be used in this library.
 */
